# Demo: Manage group lifecycle

This completed project is the result of the lab exercise **Manage group lifecycle** that is referenced in the [README](../../README.md) in this repo.
